...
- (void)testAcceptGroupInvitation {
  ...
  [[m_client groupService]
         inviteGroupMember:groupId
...
- (void)testGetMyGroups {
  ...
  [[m_client groupService] getMyGroups:successBlock
                  errorCompletionBlock:failureBlock
                              cbObject:nil];
  [self waitForResult];
...
- (void)testReadGroupEntitiesPage {
  ...
  NSString *context = [self createContext:@"entityType" searchValue:groupType];
...
- (void)authenticate:(NSString *)user {
  [[m_client authenticationService]
      authenticateUniversal:[TestFixtureBase getUser:user].m_id
...
- (NSString *)createGroupEntity {
  ...
  return
      [(NSDictionary *)[jsonObj objectForKey:@"data"] objectForKey:@"entityId"];
}
...
- (NSString *)createContext:(NSString *)searchField
...
- (NSString *)getContext:(NSString *)jsonReturn {
  ...
  return
      [(NSDictionary *)[jsonObj objectForKey:@"data"] objectForKey:@"context"];
}
